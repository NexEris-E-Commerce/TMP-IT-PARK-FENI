...
import { Grid, Cart as CartIcon, Components, Headset, User, CreditCard, Sliders, ArrowRight } from "@/components/ui/icons";

const links = [
  { href: "/admin", label: "Dashboard", icon: Grid, exact: true },
  { href: "/admin/products", label: "Products", icon: Components },
  { href: "/admin/billboard", label: "Billboard", icon: Sliders },
