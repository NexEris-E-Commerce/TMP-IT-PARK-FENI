...
/**
 * Product image gallery. The catalog currently uses generated placeholders
 * (real photo upload arrives in Phase 5), so the four "views" are subtle
 * variations of the same branded panel — but the interaction is real:
 * click/keyboard selects a view and the main stage crossfades + zooms on hover.
 * When real images land, this component takes an image[] with no UI change.
 */
const VIEWS = [
  { transform: "none" },
